...
if (global.favor <= -8) global.message2 = global.mKaliveryangry;//"SHE SEEMS VERY ANGRY WITH YOU!";
else if (global.favor < 0) global.message2 = global.mKaliangry;//"SHE SEEMS ANGRY WITH YOU.";
else if (global.favor == 0) global.message2 = global.mKaliforgive;//"SHE HAS FORGIVEN YOU!";
else if (global.favor >= 32)
{
    if (global.kaliGift >= 3 and global.favor >= 32 + (global.kaliGift-2)*16)
    {
        global.message2 = global.mKaliheals;//"YOU FEEL INVIGORATED!";
        global.kaliGift += 1;
        global.plife += rand(4,8);
    }
    else if (global.kaliGift >= 3)
    {
        global.message2 = global.mKaliecstatic;//"SHE SEEMS ECSTATIC WITH YOU!";
    }
    else if (global.bombs < 80)
    {
        global.message2 = global.mKalifillbombs;//"YOUR SATCHEL FEELS VERY FULL NOW!";
        global.kaliGift = 3;
        global.bombs = 99;
    }
    else
...
else if (global.favor >= 16)
{
    ...
    {
        global.message2 = global.mKaliveryhappy;//"SHE SEEMS VERY HAPPY WITH YOU!";
    }
    else
    {
        global.message2 = global.mKalibestows;//"SHE BESTOWS A GIFT UPON YOU!";
        global.kaliGift = 2;
...
else if (global.favor >= 8)
{
    ...
    {
        global.message2 = global.mKalihappy;//"SHE SEEMS HAPPY WITH YOU.";
    }
    else
    {
        global.message2 = global.mKalibestows;//"SHE BESTOWS A GIFT UPON YOU!";
...
else if (global.favor > 0) global.message2 = global.mKalipleased;//"SHE SEEMS PLEASED WITH YOU.";
